...
com! -nargs=0 ShowMarksOff       :call <sid>ShowMarksOff()
...
" ning: this will clall ShowMarks() when Cursor idle, I disable it
...
" Function: ShowMarksOff by ning
" Description: hide showmarks
fun! s:ShowMarksOff()
	call <sid>ShowMarksHideAll()
endf
